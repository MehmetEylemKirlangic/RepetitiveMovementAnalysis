% The function heel_tapping_analys gets the loaded data of heel_tapping after
% the pre-processing stage, analyzes the tapping process of the subject and returns 
% the calculated parameters: 
%                      'Mean maxima Tappingrate heel  in Hz',
%                      'Mean minima Tappingrate heel  in Hz',
%                      'Mean maxima Amplitude heel  in cm ',
%                      'Mean minima Amplitude heel  in cm ',
%                      'std. maxima Tappingrate heel ',
%                      'std. minima Tappingrate heel ',
%                      'Mean max and min Tappingrate heel in Hz',
%                      'std. max and min Tappingrate heel ',
%                      'Duration in sec' 
%  back. The accurate time of the measurment is also calculated and given
%  back to be shown in the heel analysis GUI.

% Program :  Repetitive Movement Analysis
% Version :  1.2
% Function:  heel_tapping_analys
...
function [Tippingrate_max,Tippingrate_min,sg_mean_max,sg_mean_min,sg_std_max,sg_std_min,...
    Time_ind1,Time_ind2,mean_max_min,std_min_max,measure_Time,Time_plot1,Time_plot2]=heel_tapping_analys(varargin)
