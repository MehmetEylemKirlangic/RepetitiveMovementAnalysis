% The function hand_tapping_function loads the hand_tapping
...
% band pass filter) to be anaylized and plotted in the hand_tapping GUI.

% Program :  Repetitive Movement Analysis
% Version :  1.2
% Function:  hand_tapping_function
% Authors  : Safwan Al-Qadhi, Dr. Mehmet Eylem Kirlangic


function [Time_Hand_Tapping,sg_Hand_Tapping,sg_Hand_Tapping_HPF]=hand_tapping_function(varargin)
