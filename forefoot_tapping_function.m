% The function forefoot_tapping_function loads the forefoot_tapping
...
% band pass filter) to be anaylized and plotted in the forefoot_tapping
% GUI.

% Program :  Repetitive Movement Analysis
% Version :  1.2
% Function:  forefoot_tapping_function
% Authors  : Safwan Al-Qadhi, Dr. Mehmet Eylem Kirlangic


function [Time_Hand_Tapping,sg_Hand_Tapping,sg_Hand_Tapping_HPF]=forefoot_tapping_function(varargin)
