% The function forefoot_tapping_analys gets the loaded data of forefoot_tapping after
% the pre-processing stage, analyzes the tapping process of the subject and returns 
% the calculated parameters: 
%                      'Mean maxima Tappingrate Forefoot  in Hz',
%                      'Mean minima Tappingrate Forefoot  in Hz',
%                      'Mean maxima Amplitude Forefoot  in cm ',
%                      'Mean minima Amplitude Forefoot  in cm ',
%                      'std. maxima Tappingrate Forefoot ',
%                      'std. minima Tappingrate Forefoot ',
%                      'Mean max and min Tappingrate Forefoot  in Hz',
%                      'std. max and min Tappingrate Forefoot ',
%                      'Duration in sec' 
%  back. The accurate time of the measurment is also calculated and given
%  back to be shown in the forefoot analysis GUI.

% Program :  Repetitive Movement Analysis
% Version :  1.2
% Function:  forefoot_tapping_analys
...
function [Tippingrate_max,Tippingrate_min,sg_mean_max,sg_mean_min,sg_std_max,sg_std_min,...
    Time_ind1,Time_ind2,mean_max_min,std_min_max,measure_Time,Time_plot1,Time_plot2]=forefoot_tapping_analys(varargin)
